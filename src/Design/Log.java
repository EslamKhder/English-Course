...
public class Log extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(10, 116, 156, 38);
        ...
        jLabel3.setBounds(10, 178, 156, 38);
        ...
        username.setBounds(170, 116, 144, 38);

        password.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        getContentPane().add(password);
        password.setBounds(170, 178, 144, 38);

        jButton1.setFont(new java.awt.Font("Yu Mincho", 3, 24)); // NOI18N
        ...
        jButton1.setBounds(94, 234, 150, 53);
        ...
        jLabel2.setBounds(10, 30, 317, 50);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (login.getUsername().trim().equalsIgnoreCase(user)
                ...
                JOptionPane.showMessageDialog(null, "Correct User And Password", "Error",
